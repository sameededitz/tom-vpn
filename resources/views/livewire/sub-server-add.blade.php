                    ...
                    <form wire:submit.prevent="submit">
                        <div class="row gy-3">
                            ...
                            <div class="col-12">
                                ...
                                <input type="text" wire:model.blur="panel_address" class="form-control" placeholder="Panel Address">
                            </div>
                            <div class="col-12">
                                <label class="form-label">Panel Address</label>
                                <textarea name="config" wire:model.blur="config" class="form-control" cols="10" rows="2" placeholder="Config"></textarea>
                            </div>
